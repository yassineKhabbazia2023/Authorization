...
namespace Pulse.Account.Infrastructure.Tests.Repositories
{
    public class AccountRepositoryTests
    {
        ...
        private readonly DbContextOptions<AuthorizationContext> _dbContextOptions;
        ...
        public AccountRepositoryTests()
        {
            ...
            _dbContextOptions = new DbContextOptionsBuilder<AuthorizationContext>()
        ...
        {
            using (var context = new AuthorizationContext(_dbContextOptions))
            {
                // Arrange
                var accountsModel = _fixture.Create<List<AccountEntity>>();
                context.AccountEntity.AddRange(accountsModel);
                await context.SaveChangesAsync();
                var accountRepository = new AuthorizationRepository(context);
