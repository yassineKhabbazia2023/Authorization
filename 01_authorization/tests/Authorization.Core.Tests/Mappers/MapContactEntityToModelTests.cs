// <copyright file="MapContactEntityToModelTests.cs" company="Pulse">
...
public class MapContactEntityToModelTests
{
    ...
    public void MapToContact_ShouldReturnContact()
    {
        ...
        // Act
        var actionResult = contactEntity.MapToContact();
    ...
    {
        var result = MapContactEntityToModel.MapToContact(null!);
